...
<body class="h-full bg-white" x-data="{ selectedItem: null, showDetail: false, cart: [] }">
    <x-navbar></x-navbar>
    <h1 class="uppercase text-4xl font-bold text-gray-700 mt-6 mb-6 ml-12">snacks</h1>
        ...
        @foreach ($drinks as $drink)
            <div
                ...
                <div class="p-4">
                    ...
                    <p class="mt-2 text-right font-medium text-blue-gray-900 text-base text-bold">Rp.
                ...
                <div class="capitalize">
                    ...
                    <div class="flex justify-center text-center gap-4 mt-6">
                        ...
                        <button class="bg-green-500 text-white text-base font-bold px-4 py-2 rounded hover:bg-green-400"
                            @click="cart.push(selectedItem); showDetail = false">
                            +
                        </button>
                    </div>
