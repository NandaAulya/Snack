<nav x-data="{ isOpen: false }" class="z-[999] w-full border-b-2 bg-white h-[120px]">
        ...
        <div class="relative flex h-[70px] items-center justify-between">
            ...
            <div class="relative ml-3">
                ...
                <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                    ...
                    class="origin-top-right absolute right-0 mt-10 w-[130px] rounded-md shadow-lg bg-purple-100 mr-10"
